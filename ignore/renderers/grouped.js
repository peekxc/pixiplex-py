 ...
 */
export const enableGroupedRenderer = (pixiplex) => {
  const renderer = new GroupedNodeRenderer(pixiplex);
  return installRendererRuntime(pixiplex, renderer, "__grouped_nodes_renderer");
};
 ...
 * @returns {object} The same host instance.
 */
export const enableGroupedNodeRenderer = enableGroupedRenderer;
